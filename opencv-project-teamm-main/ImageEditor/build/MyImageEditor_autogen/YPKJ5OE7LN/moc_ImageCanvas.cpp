...
void ImageCanvas::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::InvokeMetaMethod) {
        switch (_id) {
        case 0: _t->selectionFinished((*reinterpret_cast<std::add_pointer_t<cv::Rect>>(_a[1]))); break;
        default: ;
        }
    }
    if (_c == QMetaObject::IndexOfMethod) {
        if (QtMocHelpers::indexOfMethod<void (ImageCanvas::*)(cv::Rect )>(_a, &ImageCanvas::selectionFinished, 0))
            return;
    }
}
...
// SIGNAL 0
void ImageCanvas::selectionFinished(cv::Rect _t1)
{
